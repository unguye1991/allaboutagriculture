...
public class MarketController {
	...
	// get products by seller id REST API
	@GetMapping("/market/seller/{sellerId}")
	public ResponseEntity<List<Market>> getMarketBysellerId(@PathVariable int sellerId) {
		List<Market> market = marketRepository.findBySellerId(sellerId);
		return ResponseEntity.ok(market);
		}
